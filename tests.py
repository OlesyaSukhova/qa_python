...
class TestBooksCollector:
    ...
    def test_add_new_book_40_range(self, collector, book_name):
        collector.add_new_book(book_name)
        assert len(collector.get_books_genre()) == 1

    def test_add_new_book_45_words(self, collector):
        collector.add_new_book('ОченьОченьОченьОченьОченьОченьОченьОченьOчень')
        assert len(collector.get_books_genre()) == 0

    def test_set_book_genre_new_book(self, collector):
    ...
    def test_get_books_for_children_comedy(self, collector):
    ...
    def test_add_book_in_favorites_add_re_adding_book(self, collector):
        collector.add_new_book('Титаник')
        collector.add_new_book('Титаник')
        collector.add_book_in_favorites('Титаник')
        collector.add_book_in_favorites('Титаник')
    ...
    def test_delete_book_from_favorites_book_in_list(self, collector):
        collector.add_new_book('Титаник')
        collector.add_book_in_favorites('Титаник')
    ...
    def test_get_list_of_favorites_books_one_book_in_list(self, collector):
        collector.add_new_book('Титаник')
        collector.add_book_in_favorites('Титаник')
